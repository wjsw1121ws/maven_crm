...
<BODY>
<s:form id="linkeManForm" name="linkeManForm" action="linkMan_findAll" method="POST" theme="simple">
                        ...
                        <TD height=25>
                            <TABLE cellSpacing=0 cellPadding=2 border=0>
                                ...
                                <TR>
                                    <TD>联系人名称：</TD>
                                    <TD>
                                        <s:textfield cssClass="textbox" id="sChannel2" cssStyle="WIDTH: 80px" name="lkm_name"></s:textfield>
                                    </TD>
                                    <TD>性别：</TD>
                                    <TD>
                                        <s:select list="#{'1':'男','2':'女'}" name="lkm_gender" headerKey="" headerValue="-请选择-" cssStyle="WIDTH: 80px"></s:select>
                                    </TD>
                                    <TD>所属客户：</TD>
                                    <TD>
                                        <s:select list="list" name="customer.cust_name" headerKey="" headerValue="-请选择-" listKey="customer.cust_id" listValue="customer.cust_name"></s:select>
                                    </TD>
