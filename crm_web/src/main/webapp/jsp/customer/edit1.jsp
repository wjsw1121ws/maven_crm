						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<TR>
								...
								<INPUT class=textbox id=sChannel2
											style="WIDTH: 180px" maxLength=50 name="custName" value="<s:property value="customer.cust_name"></s:property> ">
								</td>
								<td>客户级别 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2
							...
							<TR>
								...
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="custPhone" value="<s:property value="cust_phone"></s:property> ">
								</td>
								<td>移动电话 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="custMobile" value="<s:property value="cust_mobile"></s:property> ">
								</td>
							</TR>
