...
<FORM id=form1 name=form1
      ...
      method=post enctype="multipart/form-data">
        <%--放入客户id的隐藏字段,以便后面通过,修改时需要使用到id属性--%>
        <s:hidden name="cust_id" value="%{model.cust_id}"></s:hidden>
        <%--<input type="text" name="cust_id" value="<s:property value="cust_id"></s:property> ">--%>
        <%--放入图片的隐藏字段,如果图片未修改那么可以使用原来的图片--%>
        <%--<input type="text" name="cust_image" value="<s:property value="cust_image"></s:property> ">--%>
            ...
            <TD vAlign=top width="100%" bgColor=#ffffff>
                ...
                <TABLE cellSpacing=0 cellPadding=5 border=0>
                    ...
                    <TR>
                        ...
                        <td>
                            <INPUT class=textbox id=sChannel2
                                   style="WIDTH: 180px" maxLength=50 name="cust_name" value="<s:property value="cust_name"></s:property> ">
                        </td>
                        <td>客户级别 ：</td>
                        <td>
                    ...
                    <TR>
                        ...
                        <td>
                            <INPUT class=textbox id=sChannel2
                                   style="WIDTH: 180px" maxLength=50 name="cust_phone" value="<s:property value="cust_phone"></s:property>" >
                        </td>
                        <td>移动电话 ：</td>
                        <td>
                            <INPUT class=textbox id=sChannel2
                                   style="WIDTH: 180px" maxLength=50 name="cust_mobile" value="<s:property value="cust_mobile"></s:property>">
                        </td>
